...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Location',
            fields=[
                ('locationID', models.CharField(max_length=6, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('satimage1', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='informe1', to='reports.SatImage')),
                ('satimage2', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='informe2', to='reports.SatImage')),
            ],
        ),
        migrations.CreateModel(
            name='Area',
